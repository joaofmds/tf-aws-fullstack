resource "aws_route53_record" "this" {
  ...
  # multivalue_answer_routing_policy requires set_identifier
  # Only set to true if both multivalue_answer_routing_policy is true AND set_identifier is provided
  # Otherwise, omit the attribute (null) to avoid validation errors
  multivalue_answer_routing_policy = var.multivalue_answer_routing_policy && var.set_identifier != null ? true : null
}
